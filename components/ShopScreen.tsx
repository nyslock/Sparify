                ...
                {hasCouponInInventory && (
                    <div className="max-w-5xl mx-auto w-full">
                        <button
                            ...
                            className={`w-full flex items-center justify-between p-4 rounded-2xl border-2 transition-all ${applyDiscount
                                ...
                                <div key={item.id} className="bg-white p-4 rounded-[2rem] shadow-lg shadow-slate-200/50 border-2 border-slate-100 flex flex-col items-center text-center relative overflow-hidden group">
                                    ...
                                    {owned && item.id !== 'item_streak_freeze' ? (
                                        ...
                                        <button
                                            ...
                                            disabled={!canAfford}
                                            className={`w-full font-black py-3 rounded-xl flex flex-col items-center justify-center gap-0 text-xs shadow-md transition-all active:scale-95 ${canAfford
                                ...
                                <div key={item.id} className="bg-white p-4 rounded-[2rem] shadow-xl border border-slate-100 flex flex-col items-center relative overflow-hidden group hover:scale-[1.02] transition-transform">
                                    ...
                                    {isOwned(item.id) ? (
                                        ...
                                        <button
                                            ...
                                            className={`w-full font-black py-3 rounded-xl flex flex-col items-center justify-center shadow-lg transition-all active:scale-95 text-sm ${user.coins >= price

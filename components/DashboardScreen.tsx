            ...
            <div className="p-6 xl:p-8 pb-32 max-w-7xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-10">
                    ...
                    <div className="hidden md:flex flex-col justify-center gap-4">
                        <div id="tutorial-connect" className="bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-xl h-full flex flex-col justify-center items-center text-center">
